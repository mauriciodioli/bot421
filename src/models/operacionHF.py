...
class OperacionHF:
    ...
    def enviar_orden(self):
            ...
            get.pyRofexInicializada.send_order_via_websocket(ticker=self.ticker, side=self.side, size=self.size, order_type=self.order_type, price=self.price,environment=self.environment)

...
class TarjetaUsuario(db.Model):
    ...
    mumeroTarjeta = db.Column(db.Integer, db.ForeignKey('brokers.id'), nullable=True)
    fecha_vencimiento =  db.Column(db.String(120), unique=True, nullable=False)
    cvv =  db.Column(db.String(120), unique=True, nullable=False)
    nombreApellidoTarjeta =  db.Column(db.String(120), unique=True, nullable=False) 

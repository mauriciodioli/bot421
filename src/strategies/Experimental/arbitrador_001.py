## este viene con la cuenta dr3141592654@gmail.com pass 123456789
# No se pudo redirigir al usuario se debe ingresar el usario de broker
#//showError("No se pudo redirigir al usuario se debe ingresar el usario de broker");
#src\strategies\Experimental\arbitraje_001.py
#C:\Users\dpuntillovirtual01\Documents\ITCOR\bot421\src\strategies\Experimental\arbitraje_001.py
# linea 144
...
arbitrador_001 = Blueprint('arbitrador_001',__name__)
...
@arbitrador_001.route('/Arbitrador-001/', methods=['POST'])
def Arbitrador_001():
...
def Ganancia_neta_arb(Symbol,pCI,p48hs,dz): # **33
    ...
    return Ganancia_Trade, perdida_tasa, importe_neto_cpra, importe_neto_vta, pFac, perdida_tasa 
...
def Arbitrador001(message):#
    ...
    if True:
        ...
        [Ganancia_n_arb,per_tasa, imp_neto_cpra, imp_neto_vta, price_factor, caucion] = Ganancia_neta_arb(Symbol,pCI,p48hs,dz)
        ...
        if order_counter2<2:  # solo voy a mandar dos ordenes. debug del orh.
            order_counter2 = order_counter2 + 1
            ...
            print(current_time,"-D:",Symbol,"pF",price_factor," cpraCI=", pCI, " vta48=", p48hs,DIF, "d%= {:.2f}%".format(DIFP)," dz=",dz, "cau7d",caucion,"pt",per_tasa,"inc", imp_neto_cpra,"inv",imp_neto_vta, "Gn", Ganancia_n_arb)
...
def market_data_handler_arbitraje_001(message):
    ...
    #orden_.enviar_orden()
    #print(current_time, "FUN market_data_handler_arbitraje_001: Simbolo",symbol, "precio",precio)

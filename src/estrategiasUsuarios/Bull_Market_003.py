...
Bull_Market_003 = Blueprint('Bull_Market_003',__name__)
...
@Bull_Market_003.route('/estrategia-002/', methods=['POST'])
def BullMarket003():
    ...
    if request.method == 'POST':
       ...
       #                             )
           ...
           print("no pudo conectar el websocket en Bull_Market_003.py ")
   ...
   # print("MDH respuesta desde el boton de panico", response)
    ...
    if response != 1: ### si es 1 el boton de panico fue activado
      ...
      #  print(" FUN: market_data_handler_estrategia: _")
        ...
        #  print("FUN_ Bull_Market_003 tiempoTotal en microsegundos: ",teimporAhoraInt.microseconds," en milisegundo: ",tiempomili)
    
        
@Bull_Market_003.route('/botonPanicoPortfolio/', methods = ['POST']) 
...
@Bull_Market_003.route('/botonPanico/', methods = ['POST']) 
def botonPanico():
    respuesta = botonPanicoRH('true')
    _cancela_orden(9)
    respuesta = botonPanicoRH('false')
